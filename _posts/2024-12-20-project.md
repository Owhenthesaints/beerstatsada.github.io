...
$$
    \frac{\text{nbr of breweries}}{\text{beer consumption per (wikipedia)}*\text{Countrie's nbr of inhabitants(wikipedia)}}
$$
...
<img src="/assets/img/md/Bug_bot.png" alt="bot bug">
...
<img src="/assets/img/md/seasonal_trend.png" alt="seasonal_trend">
...
<img src="/assets/img/md/seasonal_trend_style.png" alt="seasonal trend style">

(do this for choosen styles, or interactive but annoying)
